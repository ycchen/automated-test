...
class EdisPage
  ...
  #page_url'dr-prodpres-1.edis3.usitc.gov/edis3-internal'
  #page_url'https://hq-edisinternal.edis3.usitc.gov/edis3-internal/home.svc'
  ...
  link(:register, :id => "PageLink_9")
  button(:accept, :id => "agree")
  text_field(:fname, :id => "firstName")
  text_field(:lname, :id => "lastName")
  select_list(:office_div, :id => "officeDivisionSelect")
  text_field(:email_id, :id => "email")
  text_field(:user_id, :id => "loginId")
  text_field(:password, :id => "password")
  text_field(:confirm_pw, :id => "confirmPassword")
  select_list(:sec_ques_1, :id => "securityQuestion1Select")
  text_field(:sec_ans_1, :id => "securityAnswer1")
  select_list(:sec_ques_2,:id => "securityQuestion2Select")
  text_field(:sec_ans_2, :id => "securityAnswer2")
  text_field(:captcha, :id => "captchaField")
  button(:reg_submit, :value => "Submit")
  button(:acct_reg_info,:name => "completeRegistration")
  link(:rss_feed, :id => "PageLink_10")
  select_list(:rss_inv_type, :id => "aoiSelect")
  button(:rss_add_inv_type, :id => "aoiSubmit")
  button(:rss_find_add_inv, :id => "findInvButton")
  text_field(:rss_inv_no, :id => "investigationNumber")
  button(:rss_search, :id => "searchSubmit")
  link(:rss_first_inves_link, :id => "investigationGenericLink")
...
#  Submission Tab
  ...
  button(:accept_info_pdf, :text => "Accept Information")
...
#  Search Tab
  ...
  text_field(:adv_search_doc_id, :id => "docInfoFormData_documentId_BeanField")
...
#  Dockets Desk
  ...
  link(:dockets_track_doc, :id => "PageLink_10")
  select_list(:dockets_tracking_loc, :id => "trackingLocations")
  text_field(:dockets_document_id, :id => "documentId")
  button(:dockets_submit, :id => "submitForm")
